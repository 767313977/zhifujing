...
对策：`INDEX_CODE_ALIASES` 做代码归一（`_canonical_index_code`）。
...
回补 2026-03-17 ~ 2026-09-17（115 个交易日、5 个指数）：
...
数据合理性：涨跌幅范围 −7.70% ~ +10.73%，成交额范围 432亿 ~ 20,332亿，
均落在 A 股指数的合理区间内。

情绪指标回补实测（回补后可看到完整的成交额序列）：

```
日期        涨停  跌停  炸板  封板率   炸板率  连板   成交额
2026-09-04   39    9    48   44.83   55.17    5     —
2026-09-07   93    2    19   83.04   16.96    6     —
2026-09-16   89    4    11   89.00   11.00    6   18,391亿
2026-09-17   47    1    20   70.15   29.85    5   18,231亿
```
